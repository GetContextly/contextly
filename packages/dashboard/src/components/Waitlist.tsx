        ...
        >
          ...
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="w-full max-w-md p-1 rounded-[32px] bg-gradient-to-b from-white/10 to-transparent">
              <div className="bg-[#0D0E13] rounded-[31px] p-8 border border-white/5 flex flex-col gap-4">
                <button
                  onClick={handleGitHubLogin}
                  className="w-full py-4 rounded-xl bg-white text-black font-black text-sm flex items-center justify-center gap-4 hover:bg-white/90 active:scale-[0.98] transition-all group"
                >
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-white/5 border border-white/10 text-white font-bold text-sm flex items-center justify-center gap-4 hover:bg-white/10 active:scale-[0.98] transition-all group"
                >
                ...
                <div className="flex items-center gap-4 py-2">
                  ...
                  <span className="text-[9px] font-mono text-white/20 uppercase tracking-widest">or waitlist</span>
                  <div className="h-px flex-grow bg-white/5" />
                </div>
